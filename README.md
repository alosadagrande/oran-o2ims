...
* [Local Deployment Start](#local-deployment-start)
	...
	* [Run](#run-1)
		...
		* [Infrastructure Inventory Subscription Server (Resource Server)](#infrastructure-inventory-subscription-server-resource-server)
...
> :warning: Replace the IMAGE_NAME value with the full name of your container image

```bash
$ export IMAGE_NAME=quay.io/alosadag/oran-o2ims:latest
...
[3/3] COMMIT quay.io/alosadag/oran-o2ims:v4.16
--> eaa55268bfff
Successfully tagged quay.io/alosadag/oran-o2ims:latest
...
## <a name='RegisteringtheO2IMSapplicationwiththeSMO'></a>Registering the O2IMS application with the SMO
...
### <a name='QuerytheResourceserver'></a>Query the Resource server
